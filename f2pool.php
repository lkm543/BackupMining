...
class f2pool extends generalPool {
	...
	public function __construct(){
		switch ($this->Coin) {
			case 'XMC':
				this->APIurl = "http://api.f2pool.com/xmc/";
				break;
			case 'AION':
				this->APIurl = "http://api.f2pool.com/aion/";
				break;
			case 'BTC':
				this->APIurl = "http://api.f2pool.com/bitcoin/";
				break;
			case 'LTC':
				this->APIurl = "http://api.f2pool.com/litecoin/";
				break;
			case 'ETC':
				this->APIurl = "http://api.f2pool.com/etc/";
				break;
			case 'ETH':
				this->APIurl = "http://api.f2pool.com/eth/";
				break;
			case 'ZEC':
				this->APIurl = "http://api.f2pool.com/zec/";
				break;
			case 'SC':
				this->APIurl = "http://api.f2pool.com/sc/";
				break;
			case 'XMR':
				this->APIurl = "http://api.f2pool.com/monero/";
				break;
			case 'Dash':
				this->APIurl = "http://api.f2pool.com/dash/";
				break;
			case 'XZC':
				this->APIurl = "http://api.f2pool.com/zcoin/";
				break;
			case 'RVN':
				this->APIurl = "http://api.f2pool.com/raven/";
				break;
			default:
				# code...
				break;
